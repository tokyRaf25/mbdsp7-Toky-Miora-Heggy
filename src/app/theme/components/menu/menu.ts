...
export const verticalMenuItems = [ 
    new Menu (2, 'Liste des clients', '/pages/client', null, 'list-ul', null, false, 0), 
    new Menu (66, 'Creation de Paris', '/pages/creation-paris', null, 'pencil-square-o', null, false, 0), 
    new Menu (67, 'Creation de Categorie/Champ', '/pages/creation-categorie-champ', null, 'pencil-square-o', null, false, 0),
    new Menu (26, 'Listes', null, null, 'table', null, true, 0),
    new Menu (27, 'Liste des Paris', '/pages/tables/basic-tables', null, 'th', null, false, 26), 
    new Menu (28, 'Liste de Categorie/Champ', null, null, 'th-large', null, true, 26), 
    new Menu (29, 'Categorie', '/pages/tables/dynamic-tables/smart', null, 'caret-right', null, false, 28),
    new Menu (30, 'Champ', '/pages/tables/dynamic-tables/ngx', null, 'caret-right', null, false, 28),
    ...
    new Menu (50, 'Creation de point de ventes', '/pages/point-de-ventes', null, 'calendar', null, false, 0)
]
