...
export const verticalMenuItems = [ 
    ...
    new Menu (66, 'Creation de Paris', '/pages/creation-foot', null, 'pencil-square-o', null, false, 0), 
    new Menu (67, 'Creation de Categorie/Champ', '/pages/creation-tennis', null, 'pencil-square-o', null, false, 0),
